...
# CORS middleware - allow ALL origins for LAN testing (IP changes)
if DEBUG:
    # Allow ALL origins for maximum flexibility during testing
    origins = ["*"]
    allow_credentials = False  # Can't use credentials with wildcard origins
    print("CORS: Allowing ALL origins (DEBUG mode - perfect for changing IPs)")
else:
    ...
    print(f"CORS: Configured with specific origins (production)")
